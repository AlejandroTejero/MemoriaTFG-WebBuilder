...
\begin{enumerate}
  ...
  \item \textbf{Laboratorio de Bases de Datos:} Los conceptos de modelado relacional, consultas y gestión de datos aprendidos en esta asignatura han sido neccesarios para entender como diseñar los modelos de Django.
