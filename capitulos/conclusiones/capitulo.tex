...
\begin{enumerate}
  ...
  \item \textbf{Gestión autónoma de un proyecto de software:} Llevar un proyecto de esta envergadura de forma completamente autónoma, realizando investigación, tomando decisiones de arquitectura, investigando y añadiendo funcionalidades, organizando y realizando refactors cuando era necesario.
...
\begin{enumerate}
  ...
  \item \textbf{Sistema de autenticación con proveedores externos:} Incorporar la posibilidad de iniciar sesión con Google u otros proveedores mediante OAuth, simplificando el acceso a la plataforma y mejorando la experiencia de usuario.
\end{enumerate}