...
Esta fase se dividió en dos bloques principales. En primer lugar, la 
...
Hasta el momento los templates HTML eran ficheros que incluían todas las secciones en un único bloque, al igual que ocurría con los ficheros CSS y JavaScript. Como se mencionó anteriormente, esta fase introdujo una reorganización completa de la interfaz con la separación de responsabilidades.
...
Esta información resultó util para mejorar las siguientes fases donde cambios mínimos producirían grandes resultados.
