...
La home del proyecto, que hasta entonces era el fichero mas complejo, se dividió en seis partials independientes. En la Tabla~\ref{tab:partials-html} se muestra la estructura completa de partials tras el refactor:
