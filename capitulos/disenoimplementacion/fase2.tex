...
Al finalizar este scoring, se seleccionaba la lista con mayor puntuacion como 
...
Una vez localizada la colección principal, se realizo la implementacion del nuevo fichero \textbf{utils/mapping.py}, encargado de sugerir automaticamente que campos
...
Por ejemplo un campo llamado \texttt{published\_at}, obtenía un alto score para el rol fecha ya que contenia la subcadena \texttt{published}.
