...
La integración resultó más compleja de lo esperado por la acumulación de varios problemas independientes que se manifestaban con el mismo síntoma: \emph{Third-Party Login Failure}. Resolverlos requirió un proceso de depuración iterativo.
