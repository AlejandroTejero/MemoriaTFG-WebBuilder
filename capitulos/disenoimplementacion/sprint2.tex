...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|p{8cm}|}
        ...
        \hline
    \end{tabular}
    \caption{Campos del modelo APIRequest en el Sprint 2}
...
\begin{itemize}
    ...
    \item \textbf{Consistencia de claves}: si todos los diccionarios de la lista compartían aproximadamente las mismas claves, era muy probable que representaran entidades del mismo tipo.
