...
Con la fase 2 terminada y viendo que las limitaciones eran evidentes, se tomó la decisión de realizar un cambio fundamental para el futuro del proyecto. Se abandonó 
...
\begin{figure}[H]
    ...
    \caption{Flujo de ingestión y análisis: de URL a schema}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|p{8cm}|}
        ...
        \hline
    \end{tabular}
    \caption{Campos principales del modelo GeneratedSite en la Fase 3}
