...
\begin{figure}[H]
    ...
    \caption{Historial de proyectos generados por el usuario}
    \label{fig:wb-historial}
\end{figure}
...
El código fuente de WebBuilder está disponible públicamente en el siguiente repositorio de GitHub:

\begin{center}
	\url{https://...}
\end{center}

La landing page del proyecto, que incluye una descripción de las funcionalidades, los casos de uso generados y el manual de usuario, está disponible en:
