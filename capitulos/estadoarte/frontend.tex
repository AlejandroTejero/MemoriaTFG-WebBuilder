...
En cuanto a los sitios generados, Tailwind CSS~\cite{tailwind_docs} es el framework de estilo usado para los proyectos generados. La elección de Tailwind para los proyectos generados no es arbitraria, explicando sus causas más adelante.
