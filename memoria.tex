...
\title{Generación automática de proyectos django a partir de apis con ia generatriva}
...
\input{capitulos/estadoarte/capitulo}
\input{capitulos/disenoimplementacion/capitulo}
\input{capitulos/capitulo5}
\input{capitulos/capitulo6}
\input{capitulos/conclusiones/capitulo}
